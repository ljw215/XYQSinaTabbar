...
-(void)setUpChildcontroller{
    ...
    [self addChildViewController:messageVc andTitle:@"消息" andImage:[UIImage imageNamed:@"tabbar_message_center"] andSelectedImage:[UIImage imageNamed:@"tabbar_message_center_selected"]];
    ...
    [self addChildViewController:mineVc andTitle:@"我的" andImage:[UIImage imageNamed:@"tabbar_profile"] andSelectedImage:[UIImage imageNamed:@"tabbar_profile_selected"]];
}
